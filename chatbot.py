...
for doc in documents:
    ...
    # create train and test lists. X - patterns, y - patterns
    train_x = list(training_[:, 0])
    train_y = list(training_[:, 1])
    print("training data created")

# Create model - 3 layers. First layer 128 neurons, second layer 64 neurons,
# and 3rd output layer equal to number of intents to predict output intent
# with softmax
model = Sequential()
